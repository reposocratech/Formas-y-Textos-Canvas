...
# Crea formas y textos con la etiqueta Canvas de HTML

## Descripción

Sergio Jiménez, profesor del Bootcamp Full-Stack Web Developer, nos enseña como podemos crear diferentes formas y textos con la etiqueta Canvas de HTML y JavaScript.

## Vídeo

Toda la explicación está en el siguiente vídeo: [Crea formas y textos con la etiqueta Canvas de HTML](https://www.youtube.com/watch?v=vysx8zUSEOA)
